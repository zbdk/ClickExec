...
- [x] 2. ConfigurationService の実装
  - [x] 2.1 ConfigurationService クラスの実装
...
- [x] 3. PlaceholderResolver の実装
  - [x] 3.1 PlaceholderResolver クラスの実装
...
- [x] 6. TerminalManager の実装
  - [x] 6.1 TerminalManager クラスの実装
  ...
  - [x] 6.2 TerminalManager のユニットテストを作成
    - ターミナル名の設定、同名ターミナルの再利用、閉じられたターミナルの参照解放をテストする
    - `src/test/unit/terminalManager.test.ts` に実装する
    - _Requirements: 4.2, 4.3_

- [x] 7. Extension Entry Point の実装とメニュー統合
  - [x] 7.1 extension.ts の実装
  ...
  - [x] 7.2 package.json のメニュー定義を完成させる
